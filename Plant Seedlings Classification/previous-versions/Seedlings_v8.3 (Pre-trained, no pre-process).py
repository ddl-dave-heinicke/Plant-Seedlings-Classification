# Explore Keras Image Data Generator
...
plt.imshow(images[225].reshape(image_size,image_size,3))
...
#X = np.load('C:/Users/Dave/Documents/Python Scripts/Seedlings/scaled_300_300_images.npy')
