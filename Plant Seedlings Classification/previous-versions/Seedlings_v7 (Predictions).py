...
# plt.imshow(test_images[0].reshape(150,150))
# test_images[0].shape
# test_filenames[0:5]
print(np.min(test_n_contours), np.max(test_n_contours))

X_test = StandardScaler().fit_transform(test_images)
X_test = X_test.reshape(-1,150,150,1)

# Load and compile previously trained model
...
CNN_model.load_weights('CNN_4block_2Dense_1_27_18_weights.h5')
